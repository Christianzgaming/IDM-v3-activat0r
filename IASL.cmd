...
reg add "HKCU\SOFTWARE\DownloadManager" /v FName /t REG_SZ /d Christian /f >nul
reg add "HKCU\SOFTWARE\DownloadManager" /v LName /t REG_SZ /d Geronimo /f >nul
...
:quit
echo.
echo %GREEN% Thank you for using ChristianZ IDM Activation Script. Exiting...%RESET%
timeout /t 2 >nul
exit